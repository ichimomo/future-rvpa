...
(g4_future <- plot_futures(res.pma, #vpaの結果
    ...
    scale_color_hue(labels=c(VPA="過去の推定値",s1="現状の漁獲圧",s2=expression(paste("漁獲管理規則(",beta,"=0.8)") ) ) )+
    scale_fill_hue(labels=c(VPA="過去の推定値",s1="現状の漁獲圧",s2=expression(paste("漁獲管理規則(",beta,"=0.8)" ) ) ) )+
