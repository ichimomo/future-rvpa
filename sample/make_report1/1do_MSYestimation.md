...
```
    ...
    # A tibble: 34 x 15
     ...
     2 B0             FALSE 487727.   1.00   593470. 0.         0. NaN     
...
### 管理基準値の選択
  ...
  - デフォルトでは、ARなし、MSY=“Btarget0”, 0.9MSY=“Blow0”,0.6MSY=“Blimit0”,
    0.1MSY=“Bban0”になるようになっています
  - 代替候補がある場合は「管理基準値名 +
    数字」として指定
...
```
    ...
    # A tibble: 24 x 11
     ...
     1 Btarget0-Blimit0-Bban0 1.00  31000. 16000. 36000. 52000. 63000. 69000.
     2 Btarget0-Blimit0-Bban0 0.900 31000. 15000. 34000. 50000. 62000. 69000.
     3 Btarget0-Blimit0-Bban0 0.800 31000. 14000. 32000. 48000. 61000. 68000.
     4 Btarget0-Blimit0-Bban0 0.700 31000. 12000. 30000. 46000. 59000. 66000.
     5 Btarget0-Blimit0-Bban0 0.600 31000. 11000. 27000. 42000. 56000. 63000.
     6 Btarget0-Blimit0-Bban0 0.500 31000.  9000. 24000. 38000. 51000. 59000.
     7 Btarget0-Blimit1-Bban0 1.00  31000. 20000. 33000. 48000. 61000. 68000.
     8 Btarget0-Blimit1-Bban0 0.900 31000. 19000. 31000. 47000. 60000. 67000.
     9 Btarget0-Blimit1-Bban0 0.800 31000. 17000. 30000. 46000. 59000. 67000.
    10 Btarget0-Blimit1-Bban0 0.700 31000. 15000. 28000. 44000. 57000. 65000.
       `2028` `2038` stat_name 
        <dbl>  <dbl> <chr>     
...
```
    ...
    # A tibble: 24 x 11
       HCR_name                beta `2018` `2019` `2020` `2021` `2022` `2023`
       <chr>                  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>
     1 Btarget0-Blimit0-Bban0 1.00      0. -0.640 -0.510 -0.510 -0.510 -0.510
     2 Btarget0-Blimit0-Bban0 0.900     0. -0.680 -0.560 -0.560 -0.560 -0.560
     3 Btarget0-Blimit0-Bban0 0.800     0. -0.710 -0.610 -0.610 -0.610 -0.610
     4 Btarget0-Blimit0-Bban0 0.700     0. -0.750 -0.660 -0.660 -0.660 -0.660
     5 Btarget0-Blimit0-Bban0 0.600     0. -0.780 -0.710 -0.710 -0.710 -0.710
     6 Btarget0-Blimit0-Bban0 0.500     0. -0.820 -0.750 -0.750 -0.750 -0.750
     7 Btarget0-Blimit1-Bban0 1.00      0. -0.510 -0.510 -0.510 -0.510 -0.510
     8 Btarget0-Blimit1-Bban0 0.900     0. -0.560 -0.560 -0.560 -0.560 -0.560
     9 Btarget0-Blimit1-Bban0 0.800     0. -0.610 -0.610 -0.610 -0.610 -0.610
    10 Btarget0-Blimit1-Bban0 0.700     0. -0.660 -0.660 -0.660 -0.660 -0.660
       `2028` `2038` stat_name
        <dbl>  <dbl> <chr>    
     1 -0.510 -0.510 Fsakugen 
     2 -0.560 -0.560 Fsakugen 
     3 -0.610 -0.610 Fsakugen 
     4 -0.660 -0.660 Fsakugen 
     5 -0.710 -0.710 Fsakugen 
     6 -0.750 -0.750 Fsakugen 
     7 -0.510 -0.510 Fsakugen 
     8 -0.560 -0.560 Fsakugen 
     9 -0.610 -0.610 Fsakugen 
    10 -0.660 -0.660 Fsakugen 
    # ... with 14 more rows
